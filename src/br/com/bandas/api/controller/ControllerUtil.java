...
public class ControllerUtil {
	...
	public static String getJSON(boolean success, String value){
		String status = (success) ? "0" : "1";
		String description = (success) ? "Success" : "Error";
		
		if(!success){
			value = "\"" + value + "\"";
		}
		
		return "{\"status\":\"" + status + "\",\"description\":\"" + description + "\",\"value\":" + value + "}";
	}
